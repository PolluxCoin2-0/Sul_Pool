      ...
      <div className="px-4 md:px-4 lg:px-8 xl:px-16 2xl:px-28 ">
        ...
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between w-full mt-16 md:mt-12 2xl:mt-8">
          <div className="w-full md:w-[50%] xl:w-[50%]">
            ...
            <p className="text-4xl md:text-5xl lg:text-7xl xl:text-[90px] 2xl:text-[110px]  text-transparent bg-clip-text bg-purpleGradient wallpoet-regular drop-shadow-lg tracking-wide mt-1">
              SULPOOL
            </p>
            <p className="text-white syne-font text-xs md:text-sm lg:text-lg xl:text-xl mt-1">
          ...
          <div className="w-full md:w-[50%] xl:w-[50%] md:-mt-16">
            <img src={HomeImg} alt="" className="w-full" />
          </div>
        </div>

        {/* balance */}
        <div className="flex flex-col md:flex-row justify-between items-center text-center space-x-0 md:space-x-6 xl:space-x-12 w-full">
          <div className="w-[60%] md:w-[25%] lg:w-[20%]">
            <p className="text-white syne-font text-md lg:text-lg pb-1 md:pb-2 mt-0 md:mt-6 lg:mt-8 xl:mt-0">Pool Balance</p>
          ...
          <div className="w-[60%] md:w-[25%] lg:w-[20%] mt-6 lg:mt-8 xl:mt-0">
        ...
        {/* sulpool stake */}
        <div className="bg-white bg-opacity-10 border-[1px] border-white border-opacity-5 rounded-2xl mt-10 md:mt-20 text-center pt-6 lg:pt-0 xl:pt-8 2xl:pt-12 pb-6 md:pb-8 lg:pb-12">
          <p className="text-white wallpoet-regular text-3xl md:text-4xl xl:text-5xl">SULPOOL STAKE</p>

          {/*STAKING PLANS */}
          <div className="flex flex-col md:flex-row justify-around mt-6 md:mt-8 lg:mt-12 w-full space-x-0 md:space-x-4 lg:space-x-6 xl:space-x-12 px-6 lg:px-6 xl:px-20">
            ...
            <div className="bg-darkGray shadow-custom rounded-xl w-full md:w-[20%] pt-4 lg:pt-8 hover:bg-revpurpleGradient mt-4 md:mt-0">
              <p className="syne-font text-white text-xl lg:text-2xl">36 Month</p>
              <p className="syne-font text-white text-md lg:text-lg pt-2 lg:pt-4 pb-2 lg:pb-4">APR</p>
